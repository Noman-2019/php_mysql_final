...
-- Database: `evi_exam`
--
CREATE DATABASE IF NOT EXISTS `evi_exam` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `evi_exam`;
...
INSERT INTO `manufacturer` (`id`, `name`, `address`, `contact_no`) VALUES
(1, 'walton', 'dhaka', '01777777777'),
(3, 'samsung', 'korea', '01999999999'),
(4, 'sony', 'japan', '01999999999'),
(8, 'apple', 'usa', '3214242'),
(9, 'nokia', 'finlanfd', '3214242'),
(10, 'vivo', 'china', '3214242');

--
-- Triggers `manufacturer`
--
DELIMITER $$
CREATE TRIGGER `del_manufact` AFTER DELETE ON `manufacturer` FOR EACH ROW DELETE FROM product WHERE product.manufacturer_id=OLD.id
$$
DELIMITER ;
...
('root', '[{\"db\":\"evidance\",\"table\":\"manufacturer\"},{\"db\":\"evidance\",\"table\":\"product\"},{\"db\":\"wdpf\",\"table\":\"manufacturer\"},{\"db\":\"wdpf\",\"table\":\"product\"},{\"db\":\"wdpf\",\"table\":\"Manufacturer\"},{\"db\":\"wdpf60\",\"table\":\"users\"},{\"db\":\"wdpf60\",\"table\":\"product\"},{\"db\":\"wdpf60\",\"table\":\"catagories\"}]');
...
('root', 'wdpf60', 'product', '{\"sorted_col\":\"`product`.`product_name` ASC\"}', '2024-08-21 04:49:50');
...
('root', '2024-08-24 03:43:39', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `practice_1`
--
CREATE DATABASE IF NOT EXISTS `practice_1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `practice_1`;
...
(1, 'abir', 'savar', '1234242'),
(2, 'asif', 'n.ganj', '435435'),
(3, 'amin', 'dhaka', '3424232'),
(4, 'saif', 'kaptanbazar', '342342332'),
(5, 'rokib', 'shabag', '343242'),
(6, 'abdullah', 'cumilla', '435435');

--
-- Triggers `student`
--
DELIMITER $$
CREATE TRIGGER `del_result` AFTER DELETE ON `student` FOR EACH ROW DELETE FROM result WHERE result.student_id=OLD.id
$$
DELIMITER ;
...
--
-- Database: `tablejquery`
--
CREATE DATABASE IF NOT EXISTS `tablejquery` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tablejquery`;

-- --------------------------------------------------------

--
-- Table structure for table `jq`
--
...
--
-- Dumping data for table `jq`
--

INSERT INTO `jq` (`id`, `name`, `details`) VALUES
(1, 'dhaka ', 'city of mosque'),
(2, 'cumilla', 'city of rasmalai'),
(3, 'rajshahi', 'city of mango');
...
--
-- AUTO_INCREMENT for table `jq`
--
ALTER TABLE `jq`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- Database: `tclk_wdpf_60`
--
CREATE DATABASE IF NOT EXISTS `tclk_wdpf_60` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tclk_wdpf_60`;
...
INSERT INTO `manufacturer` (`id`, `name`, `address`, `contact_no`) VALUES
(1, 'yamaha', 'japan', '3213123213'),
(2, 'suzuki', 'tokyo', '1332123231'),
(6, 'sony', 'japan', '324335'),
(7, 'akij', 'chattogram', '123456789');

--
-- Triggers `manufacturer`
--
DELIMITER $$
CREATE TRIGGER `manufacturer_del` AFTER DELETE ON `manufacturer` FOR EACH ROW DELETE FROM product WHERE product.manufacturer_id=OLD.id
$$
DELIMITER ;
